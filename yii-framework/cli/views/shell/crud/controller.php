...
{
	/**
	 * @var string the default layout for the views. Defaults to '//layouts/column3-9', meaning
	 * using two-column layout. See 'protected/views/layouts/column3-9.php'.
	 */
	public $layout='//layouts/column3-9';
