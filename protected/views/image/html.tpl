...
<div id="image_upload_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
...
<script id="template-download" type="text/x-tmpl">
    ...
    <tr class="template-download fade" file_id="{%=file.id%}">
        ...
        <td>
            <button class="btn btn-danger delete fright" data-type="{%=file.delete_type%}" data-url="{%=file.delete_url%}"{% if (file.delete_with_credentials) { %} data-xhr-fields='{"withCredentials":true}'{% } %}>
