    ...
    public function __toString()
    {
        ...
        if (is_array($representingColumn)) {
            ...
            foreach ($representingColumn as $representingColumn_item) {
                $column_representation = $representingColumn_item;

                if (isset($this->$representingColumn_item)) {
                    $column_representation = $this->$representingColumn_item;
                    if ($column_representation === null) {
                        $column_representation = '';
                    }
                    $part .= $split . $column_representation;
                    $split = " - ";
                } else {
                    $part .= $column_representation;
                    $split = '';
                }
            }
            return $part;
    ...
    public function findAllAttributes($attributes = null, $withPk = false, $condition = '', $params = array())
    {
        ...
        if ($attributes === null) {
            ...
            foreach ($attributes as $key => $attribute) {
                if (!isset($this->getMetaData()->columns[$attribute])) {
